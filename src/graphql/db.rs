...
use crate::db::schema::messages::dsl::{
    asserted_time, author_id, content, content_type, is_decrypted, key_id,
    messages as messages_table, received_time, seq as seq_row,
};
    ...
    field process(&executor, chunk_size = 100: i32) -> ProcessResults {
        ...
        log_iter
            ...
            .for_each(|chunk|{
                ...
                let messages: Vec<SsbMessage> = chunk
                    .map(|log_entry|{
